from data_handling2 import get_top_words, get_categories_words, save_words_df, load_words_df
...
# Scale edge weights (cos_sim) to a reasonable width range (e.g., 1 to 10)
...
for edge in net.edges:
    ...
    # Normalize similarity to a width scale (1 to 10)
